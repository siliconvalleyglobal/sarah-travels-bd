import { SARAH_BOOKING_ACCENT } from "./sarah-booking-shared";

const INACTIVE = "#9ca3af";

export function SarahTabIcon({ id, active }: { id: string; active: boolean }) {
  const color = active ? SARAH_BOOKING_ACCENT : INACTIVE;

  switch (id) {
    case "hotels":
      return (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" aria-hidden className="h-9 w-9">
